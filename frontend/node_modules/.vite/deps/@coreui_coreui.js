...
var NAME$h = "alert";
var DATA_KEY$c = "coreui.alert";
var EVENT_KEY$d = `.${DATA_KEY$c}`;
var EVENT_CLOSE = `close${EVENT_KEY$d}`;
var EVENT_CLOSED = `closed${EVENT_KEY$d}`;
...
var NAME$g = "button";
var DATA_KEY$b = "coreui.button";
var EVENT_KEY$c = `.${DATA_KEY$b}`;
var DATA_API_KEY$8 = ".data-api";
var CLASS_NAME_ACTIVE$4 = "active";
var SELECTOR_DATA_TOGGLE$6 = '[data-coreui-toggle="button"]';
var EVENT_CLICK_DATA_API$8 = `click${EVENT_KEY$c}${DATA_API_KEY$8}`;
...
var NAME$f = "swipe";
var EVENT_KEY$b = ".coreui.swipe";
var EVENT_TOUCHSTART = `touchstart${EVENT_KEY$b}`;
var EVENT_TOUCHMOVE = `touchmove${EVENT_KEY$b}`;
var EVENT_TOUCHEND = `touchend${EVENT_KEY$b}`;
var EVENT_POINTERDOWN = `pointerdown${EVENT_KEY$b}`;
var EVENT_POINTERUP = `pointerup${EVENT_KEY$b}`;
...
var NAME$e = "carousel";
var DATA_KEY$a = "coreui.carousel";
...
var EVENT_KEYDOWN$1 = `keydown${EVENT_KEY$a}`;
var EVENT_MOUSEENTER$1 = `mouseenter${EVENT_KEY$a}`;
var EVENT_MOUSELEAVE$1 = `mouseleave${EVENT_KEY$a}`;
var EVENT_DRAG_START = `dragstart${EVENT_KEY$a}`;
var EVENT_LOAD_DATA_API$5 = `load${EVENT_KEY$a}${DATA_API_KEY$7}`;
var EVENT_CLICK_DATA_API$7 = `click${EVENT_KEY$a}${DATA_API_KEY$7}`;
...
var NAME$d = "collapse";
var DATA_KEY$9 = "coreui.collapse";
var EVENT_KEY$9 = `.${DATA_KEY$9}`;
var DATA_API_KEY$6 = ".data-api";
var EVENT_SHOW$7 = `show${EVENT_KEY$9}`;
var EVENT_SHOWN$7 = `shown${EVENT_KEY$9}`;
var EVENT_HIDE$7 = `hide${EVENT_KEY$9}`;
var EVENT_HIDDEN$7 = `hidden${EVENT_KEY$9}`;
var EVENT_CLICK_DATA_API$6 = `click${EVENT_KEY$9}${DATA_API_KEY$6}`;
...
var NAME$c = "dropdown";
var DATA_KEY$8 = "coreui.dropdown";
...
var EVENT_HIDE$6 = `hide${EVENT_KEY$8}`;
var EVENT_HIDDEN$6 = `hidden${EVENT_KEY$8}`;
var EVENT_SHOW$6 = `show${EVENT_KEY$8}`;
var EVENT_SHOWN$6 = `shown${EVENT_KEY$8}`;
var EVENT_CLICK_DATA_API$5 = `click${EVENT_KEY$8}${DATA_API_KEY$5}`;
var EVENT_KEYDOWN_DATA_API = `keydown${EVENT_KEY$8}${DATA_API_KEY$5}`;
...
var SELECTOR_DATA_TOGGLE$4 = '[data-coreui-toggle="dropdown"]:not(.disabled):not(:disabled)';
var SELECTOR_DATA_TOGGLE_SHOWN = `${SELECTOR_DATA_TOGGLE$4}.${CLASS_NAME_SHOW$8}`;
...
var EVENT_MOUSEDOWN = `mousedown.coreui.${NAME$b}`;
var Default$a = {
...
var NAME$a = "focustrap";
var DATA_KEY$7 = "coreui.focustrap";
var EVENT_KEY$7 = `.${DATA_KEY$7}`;
var EVENT_FOCUSIN$2 = `focusin${EVENT_KEY$7}`;
...
var NAME$9 = "modal";
var DATA_KEY$6 = "coreui.modal";
var EVENT_KEY$6 = `.${DATA_KEY$6}`;
var DATA_API_KEY$4 = ".data-api";
var ESCAPE_KEY$1 = "Escape";
var EVENT_HIDE$5 = `hide${EVENT_KEY$6}`;
var EVENT_HIDE_PREVENTED$1 = `hidePrevented${EVENT_KEY$6}`;
var EVENT_HIDDEN$5 = `hidden${EVENT_KEY$6}`;
var EVENT_SHOW$5 = `show${EVENT_KEY$6}`;
var EVENT_SHOWN$5 = `shown${EVENT_KEY$6}`;
var EVENT_RESIZE$2 = `resize${EVENT_KEY$6}`;
...
var EVENT_CLICK_DATA_API$4 = `click${EVENT_KEY$6}${DATA_API_KEY$4}`;
...
var NAME$8 = "navigation";
var DATA_KEY$5 = "coreui.navigation";
...
var EVENT_CLICK_DATA_API$3 = `click${EVENT_KEY$5}${DATA_API_KEY$3}`;
var EVENT_LOAD_DATA_API$4 = `load${EVENT_KEY$5}${DATA_API_KEY$3}`;
...
var Navigation = class _Navigation extends BaseComponent {
  constructor(element, config) {
    super(element);
    this._config = this._getConfig(config);
    this._setActiveLink();
  ...
  _setActiveLink() {
    for (const element of Array.from(this._element.querySelectorAll(SELECTOR_NAV_LINK))) {
      ...
      if (this._config.activeLinksExact && element.href === currentUrl) {
        ...
        Array.from(this._getParents(element, SELECTOR_NAV_GROUP)).forEach((element2) => {
  ...
  static navigationInterface(element, config) {
    const data = _Navigation.getOrCreateInstance(element, config);
    if (typeof config === "string") {
      if (typeof data[config] === "undefined") {
        throw new TypeError(`No method named "${config}"`);
      }
  ...
  static jQueryInterface(config) {
    return this.each(function() {
      _Navigation.navigationInterface(this, config);
    });
  }
};
...
var NAME$7 = "offcanvas";
var DATA_KEY$4 = "coreui.offcanvas";
var EVENT_KEY$4 = `.${DATA_KEY$4}`;
var DATA_API_KEY$2 = ".data-api";
var EVENT_LOAD_DATA_API$3 = `load${EVENT_KEY$4}${DATA_API_KEY$2}`;
var ESCAPE_KEY = "Escape";
var CLASS_NAME_SHOW$4 = "show";
var CLASS_NAME_SHOWING$1 = "showing";
var CLASS_NAME_HIDING = "hiding";
var CLASS_NAME_BACKDROP$1 = "offcanvas-backdrop";
...
var EVENT_MODAL_HIDE = "hide.coreui.modal";
var TRIGGER_HOVER = "hover";
var TRIGGER_FOCUS = "focus";
var TRIGGER_CLICK = "click";
var TRIGGER_MANUAL = "manual";
var EVENT_HIDE$3 = "hide";
var EVENT_HIDDEN$3 = "hidden";
var EVENT_SHOW$3 = "show";
var EVENT_SHOWN$3 = "shown";
...
var EVENT_CLICK_DATA_API$1 = `click${EVENT_KEY$2}${DATA_API_KEY}`;
...
var Sidebar = class _Sidebar extends BaseComponent {
  ...
  static sidebarInterface(element, config) {
    const data = _Sidebar.getOrCreateInstance(element, config);
    if (typeof config === "string") {
      if (typeof data[config] === "undefined") {
        throw new TypeError(`No method named "${config}"`);
      }
  ...
  static jQueryInterface(config) {
    return this.each(function() {
      _Sidebar.sidebarInterface(this, config);
    });
  }
};
...
var SELECTOR_DATA_TOGGLE_ACTIVE = `.${CLASS_NAME_ACTIVE}[data-coreui-toggle="tab"], .${CLASS_NAME_ACTIVE}[data-coreui-toggle="pill"], .${CLASS_NAME_ACTIVE}[data-coreui-toggle="list"]`;
...
//# sourceMappingURL=@coreui_coreui.js.map
