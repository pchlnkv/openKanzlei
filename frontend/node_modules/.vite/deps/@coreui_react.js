...
var getReferenceElement = (reference, dropdownToggleElement, dropdownRef) => {
  if (reference === "parent") {
...
var CDropdownMenu = (0, import_react52.forwardRef)((_a, ref) => {
  ...
  const { alignment, container, dark, dropdownMenuRef, popper, portal, visible } = (0, import_react52.useContext)(CDropdownContext);
  ...
  return import_react52.default.createElement(
    ...
    import_react52.default.createElement(Component, Object.assign({ className: classNames("dropdown-menu", {
      show: visible
    }, alignment && getAlignmentClassNames(alignment), className), ref: forkedRef, role: "menu" }, !popper && { "data-coreui-popper": "static" }, dark && { "data-coreui-theme": "dark" }, rest), Component === "ul" ? import_react52.default.Children.map(children, (child, index) => {
